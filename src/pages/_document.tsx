  ...
  '@graph': [
    {
      ...
      image: {
        '@type': 'ImageObject',
        '@id': 'https://rodrigocastilho.com/#image',
        url: 'https://rodrigocastilho.com/rodrigo-castilho-rodcast_photo.jpg',
        contentUrl:
    ...
    },
    {
      ...
      name: metadata.title,
      description: metadata.description,
      isPartOf: { '@id': 'https://rodrigocastilho.com/#website' },
    ...
    {
      '@type': 'ProfilePage',
      '@id': 'https://rodrigocastilho.com/#profilepage',
      url: 'https://rodrigocastilho.com/',
      name: metadata.title,
      description: metadata.description,
      isPartOf: { '@id': 'https://rodrigocastilho.com/#website' },
      mainEntity: { '@id': 'https://rodrigocastilho.com/#person' },
      inLanguage: 'en-US',
    },
  ],
};
